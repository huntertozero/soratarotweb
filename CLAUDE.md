...
> 완료된 Phase 1~31 상세 이력 → **DONE.md** 참고
...
| 영역 | 완료 내용 |
|------|-----------|
| 백엔드 | Express API, 24시간 사용 제한(쿠키), 스프레드별 타임아웃/토큰 분리 |
| 프론트엔드 | 78장 선택(매 진입마다 위치 랜덤화), 카드 플립, READING 3열 레이아웃, marked.js 마크다운 |
| 애니메이션 | Canvas 파티클 배경, 오라클 구체 로딩, 카드 스파크/플래시 |
| 모바일 | 반응형 레이아웃 전면 개선, 켈틱 크로스 PC/모바일 플립 순서 분기, 잠긴 카드 스택 정렬 버그 수정 |
